                        ...
                        <tbody>
                          <tr>
                            <td style="width:150px;">
                              <img src="{{asset('assets/images/logo.png')}}" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150" height="auto" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
      ...
      <![endif]-->
                  ...
                  <tr>
                    <td style="font-size:0px;padding:10px 25px;word-break:break-word;" align="center">
                      <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:24px;font-weight:300;line-height:30px;text-align:left;color:#000000;">Bienvenue sur Nunua</div>
                    </td>
                  </tr>
                  <tr>
                    <td style="font-size:0px;padding:10px 25px;word-break:break-word;" align="center">
                      <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:300;line-height:20px;text-align:left;color:#000000;">Vous venez de créer un compte sur Nunua, Votre code de validation est :</div>
                    </td>
                  </tr>
                  <tr>
                      ...
                      <table role="presentation" style="border-collapse:separate;line-height:100%;" cellspacing="0" cellpadding="0" border="0">
                        <tbody><tr>
                          <td role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:8px 16px;background:#54595f;" valign="middle" bgcolor="#54595f" align="center">
                            <a style="display: inline-block; background: #54595f; color: white; font-family: Roboto, Helvetica, Arial, sans-serif; font-size: 18px; font-weight: bold; line-height: 20px; margin: 0; text-decoration: none; text-transform: none; padding: 8px 16px; mso-padding-alt: 0px; border-radius: 3px;">{{$code}} </a>
                          </td>
                        </tr>
                      </tbody></table>
                    </td>
